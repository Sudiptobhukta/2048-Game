...
class Game2048(Frame):
    def __init__(self):
        ...
        self.mainloop() #this method tells the tkinter to run, this method listens to the events such as botton press, keypress and any movements in the keyboard

    def init_grid(self):
        background = Frame(self,bg=c.BACKGROUND_COLOR_GAME, width=c.SIZE, height=c.SIZE)
        ''' we wrote "self" inside the frame because this tells that we are building 
                another frame inside the Pre-existence frame'''
        ...
        for i in range(c.GRID_LEN):
            ...
            for j in range(c.GRID_LEN):
                ...
                t= Label(master=cell, text="", justify=CENTER, font= c.FONT, width=5,
                height=2)
